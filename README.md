...
| <a name="input_spacelift_url"></a> [spacelift\_url](#input\_spacelift\_url) | Full URL of the Spacelift API endpoint to use, eg. https://demo.app.spacelift.io | `string` | n/a | yes |
